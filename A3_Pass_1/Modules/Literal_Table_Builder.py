...
***      - Literal_Table_Builder : Coordinates the overall flow of the program,            ***
...
import sys
import os
from Symbol_Table_Builder import Symbol_Table_Builder, FileExplorer
from ErrorLogHandler import ErrorLogHandler




class Literal_Table_Builder:
    ...
    """
    /***************************************************************************************
    ***  CLASS NAME : Literal_Table_Builder                                                  ***
    ***  DESCRIPTION :                                                                    ***
    ...
    ***************************************************************************************/
    ...
    def __init__(self):
        ...
        ***  METHOD : __init__                                                                ***
        ***  DESCRIPTION :                                                                    ***
        ***      Initializes the Literal_Table_Builder with all necessary components.            ***
        ***************************************************************************************/

        Initialize the Literal_Table_Builder with all necessary components.
        """
        ...
        self.symbol_table_driver = Symbol_Table_Builder()  # Use Symbol_Table_Builder to manage symbol table
    ...
    def build_symbol_table(self):
        ...
        ***  DESCRIPTION :                                                                    ***
        ***      Builds the symbol table using the Symbol_Table_Builder and logs the actions.    ***
        ***************************************************************************************/

        Build the symbol table using Symbol_Table_Builder.
        """
        try:
...
def main():
    ...
    ***  FUNCTION : main                                                                  ***
    ***  DESCRIPTION :                                                                    ***
    ***      Creates an instance of Literal_Table_Builder and runs the program with the      ***
    ***      expression file passed via command line or default.                          ***
    ***************************************************************************************/
    """
    # Create an instance of Literal_Table_Builder and run it
    expression_file = sys.argv[1] if len(sys.argv) > 1 else None
    driver = Literal_Table_Builder()
